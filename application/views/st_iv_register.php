        ...
        <div id="contant" onselectstart="return false;" style="-moz-user-select:none;">
            <div class="container">
                ...
                <div  id="register">
                    <div id="dec"></div>
                    <div class="wrapper">
                        <form action="user/do_st_iv_reg" name="ivreg" method="post" id="become" enctype="multipart/form-data">
                            <input type = "hidden" accept="image/*" capture="camera" id="img" class="input-upload-image" name="photo" />
                     
                                <div class="headline">任职公司</div>
                                <div class="information">
                                    <div class="form-group">
                                        <label for="company">公司</label><span class="i">*</span>
                                        <input type="text" name="company" class="form-control empty" id="company">
            ...
            <script src="assets/js/require.js" data-main="assets/js/st_iv_register"></script>
