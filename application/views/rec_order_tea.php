            ...
            <div class="order-details">
                ...
                <?php if($teas){?>
                    <?php foreach($teas as $tea):?>
                        <div class="box <?php echo $tea->rec_id;?> ">
                            <li class="col">
                            ...
                            <li class="row1">
                                ...
                                <span class="order-job">
                                    内推公司：<?php echo $tea->company;?>
                                </span>
                                <span class="order-way">
                                    内推职位：<?php echo $tea->position;?>
                                </span>
                                <span class="order-sallary">
                                    <?php echo $tea->money;?>元
                                </span>
                                <span class="order-help2 del-wait" info="<?php echo $tea->rec_id?>">删除</span>
                            </li>
                        </div>
                    <?php endforeach ?>
                <?php }?>
                    ...
                    for($i=0;$i<count($orders);$i++){
                        ...
                        <div class="box">
							...
							<span class="order-user">
								被推荐：<span class="user"><?php echo $names[$i]->nick_name;?></span>
							</span>
							<span class="order-jl">
							...
							<span class="order-sallary">
                                ...
                                <?php if($orders[$i]->status == 0){
                                    echo '<span >
								<button class="order-help1 help-it" id="oder">帮他内推</button>
							</span>
							<span class="order-help2">
								不帮内推
							</span>';
                                }
                                elseif($orders[$i]->status == 1){
                                ...
                                elseif($orders[$i]->status == 3){
                                    echo '<span data-toggle="modal" data-target="#myModal-video2" class="order-wan cancel">
								确认取消
							</span>';
                                }
                                elseif($orders[$i]->status == 4){
    ...
    <div class="modal-dialog">
        <div class="modal-content model-video-con">
            ...
            <div class="modal-body mod-body">
                <textarea name="" id="modal-textarea2" cols="30" rows="10" placeholder="请输入取消原因"></textarea>
            </div>
